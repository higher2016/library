...
public class MultiThreadQueueWorker<K, V> implements IControl {
	...
	public MultiThreadQueueWorker(String name, int threadNum, int warnSize, boolean enableIOMonitor, double warnIORate,
			long printIOPeriod, IProcessor<K, V> processor) {
		this.name = name;
	...
	public MultiThreadQueueWorker(String name, int threadNum, int warnSize, double warnIORate,
